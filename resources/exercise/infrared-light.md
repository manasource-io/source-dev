...
components:
  ...
  - mitochondrial
description: >-
  Photobiomodulation using 660–850nm wavelengths to stimulate mitochondrial ATP
  production, reduce inflammation, and support tissue recovery
score: 3
...
claims:
  ...
  - id: anti-inflammatory
    label: Modulates ROS signaling and reduces local inflammation markers
  - id: muscle-recovery
    label: Reduces post-exercise fatigue and soreness; accelerates tissue repair
  - id: skin-rejuvenation
    label: Stimulates collagen synthesis and wound healing in dermal tissue
references:
  - url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC5523874/'
    title: >-
      Mechanisms and applications of the anti-inflammatory effects of
      photobiomodulation.
    date: '2017-05-19'
  ...
  - url: 'https://pubmed.ncbi.nlm.nih.gov/39883205/'
    title: >-
      A systematic review on whole-body photobiomodulation for exercise
      performance and recovery.
    date: '2025-01-30'
  - url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC4637912/'
    title: >-
      CURRENT CONCEPTS OF MUSCLE AND TENDON ADAPTATION TO STRENGTH AND
      CONDITIONING.
    date: '2015-11-01'
---
