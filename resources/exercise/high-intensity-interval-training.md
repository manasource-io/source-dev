...
category: cardio
description: Alternating bursts of near-maximal effort with recovery periods; highly
  time-efficient way to build cardiorespiratory fitness, improve VO2max, and enhance
  cardiometabolic health
benefits:
- id: vo2max
  label: Superior VO2max gains vs moderate-intensity training, especially in older
    adults
